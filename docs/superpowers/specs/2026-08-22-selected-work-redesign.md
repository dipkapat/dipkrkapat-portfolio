...
--shadow-card-outer: 0 4px 24px rgba(13, 13, 13, 0.04), 0 1px 3px rgba(13, 13, 13, 0.03);

/* Inner core - nearly invisible depth */
--shadow-card-inner: 0 2px 8px rgba(13, 13, 13, 0.02);

/* Hover - gentle elevation bloom */
--shadow-card-hover: 0 12px 48px rgba(13, 13, 13, 0.06), 0 4px 16px rgba(13, 13, 13, 0.04);
```
