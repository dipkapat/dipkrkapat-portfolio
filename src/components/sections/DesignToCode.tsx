  ...
  return (
    <section className="py-20 lg:py-28">
      <Container>
            ...
            {workflowSteps.map((step, index) => (
              <li key={step.label} className="relative flex-1">
                <div className="flex h-full flex-col border-t border-border pt-5">
                  ...
                  <h3 className="mt-3 text-lg font-medium tracking-tight text-text-primary">
                    {step.label}
                  </h3>
        ...
        <Reveal delay={0.18}>
          <p className="mt-14 border-l-2 border-accent pl-5 font-serif text-xl italic leading-relaxed text-text-primary sm:text-2xl">
