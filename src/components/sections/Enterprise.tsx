					...
					<div className="lg:col-span-5">
						<Reveal>
							...
							<p className="mt-6 text-base leading-relaxed text-text-secondary">
								For an enterprise School Automation Software
								platform, I worked across the product ecosystem
								- from UI/UX design and prototyping through
								frontend implementation.
							</p>
							<p className="mt-4 text-base leading-relaxed text-text-secondary">
								The challenge was not designing individual
								screens. It was creating a consistent, scalable
								interface system across a large and
