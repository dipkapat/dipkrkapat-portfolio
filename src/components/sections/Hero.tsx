          ...
          <div className="min-w-0 lg:col-span-7">
            ...
            <Reveal delay={0.16}>
              <p className="mt-7 max-w-xl text-base leading-relaxed text-text-secondary sm:text-lg">
                18+ years across web design, product UI/UX, and frontend
                development — combining product thinking, visual precision, and
                modern frontend technology to create clear, responsive,
            ...
            <Reveal delay={0.2}>
              <div className="grid grid-cols-2 gap-px overflow-hidden rounded-md border border-border bg-border">
                {proofPoints.map((point) => (
                  <div key={point.value} className="bg-surface p-5 sm:p-6">
