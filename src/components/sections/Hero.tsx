  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse 80% 50% at 50% 0%, var(--accent-3) 0%, transparent 70%)",
          opacity: 0.4,
        }}
      />
      ...
      <Container className="relative">
          ...
          <div className="min-w-0 lg:col-span-7">
            ...
            <Reveal delay={0.16}>
              <p className="mt-8 max-w-[52ch] text-base leading-relaxed text-fg-1 sm:text-lg lg:text-base">
                18+ years across web design, product UI/UX, and frontend development —
                combining product thinking, visual precision, and modern frontend technology
                to create clear, responsive, production-ready experiences.
              </p>
            </Reveal>
          ...
          <div className="min-w-0 lg:col-span-5">
            <Reveal delay={0.2} y={30}>
              <div className="grid grid-cols-2 gap-px overflow-hidden rounded-md border border-border bg-border">
                {proofPoints.map((point, index) => (
                  ...
                  >
                    <Stat value={point.value} label={point.label} />
                  </motion.div>
                ))}
              </div>
            </Reveal>
            ...
            <Reveal delay={0.28} y={30}>
              <div className="mt-6 flex items-center gap-4 rounded-md border border-border bg-surface px-5 py-4">
                ...
                <span className="text-fg-2" aria-hidden="true">→</span>
        ...
        <motion.div
          ...
          aria-hidden="true"
        >
          <p className="font-mono text-[10px] uppercase tracking-[0.15em]">Scroll</p>
          <motion.div
