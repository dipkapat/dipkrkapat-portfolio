  ...
  return (
    <section className="py-20 lg:py-28">
      <Container>
        ...
        />
        <Stagger className="mt-12 grid gap-px overflow-hidden rounded-md border border-border bg-border sm:grid-cols-2 lg:grid-cols-5" stagger={0.08}>
          {principles.map((principle) => (
            <StaggerItem key={principle.index} className="bg-surface p-6">
