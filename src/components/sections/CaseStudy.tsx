			...
			<Container className="py-12">
				...
				>
					...
					<div className="rounded-[20px] bg-bg-0 p-6 sm:p-8">
						...
						<p className="mt-2 text-sm text-fg-0">
							{project.category}
						</p>
					</div>
					<div className="rounded-[20px] bg-bg-0 p-6 sm:p-8">
				...
				<motion.div
					...
					className="mt-6 rounded-2xl border border-accent-0/30 bg-accent-0/5 p-6 sm:p-8"
				>
					<p className="font-mono text-xs uppercase tracking-[0.12em] text-accent-0">
						Outcome
					</p>
					<p className="mt-3 max-w-3xl text-lg leading-relaxed text-fg-0 sm:text-xl">
						{project.result}
					</p>
				</motion.div>
				...
				>
					...
					<Section
						...
						items={project.productStructure}
						index={3}
					/>
					<Section
						title="Key UX Decisions"
						items={project.uxDecisions}
						index={4}
					/>
					<Section
						title="UI System"
						items={project.uiSystem}
						index={5}
					/>
					<Section
						title="Interaction"
						items={project.interaction}
						index={6}
					/>
					<Section
						title="Frontend"
