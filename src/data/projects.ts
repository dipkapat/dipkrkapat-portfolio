...
export const projects: Project[] = [
  {
    ...
    stack: ["React", "Next.js", "Tailwind CSS", "shadcn/ui", "Recharts", "Framer Motion"],
    liveUrl: "https://pulse-metrics-beta.vercel.app/",
    image: {
      src: "/work/pulsemetrics.svg",
      alt: "PulseMetrics analytics dashboard interface preview",
      width: 1280,
      height: 800,
    },
    highlight: "Data-dense enterprise dashboard patterns for a B2B SaaS analytics product.",
    problem:
    ...
    users:
      "Product managers, growth leads, and business operators who review SaaS metrics daily and need fast, reliable answers about performance.",
    productStructure: [
    ...
    result:
      "A cohesive B2B SaaS dashboard demonstrating the specific UI patterns analytics products demand: dense data presentation, role-aware views, and interactions that never get in the way of reading data.",
    reflection:
  ...
  },
  {
    ...
    image: {
      src: "/work/ai-content-studio.svg",
    ...
    users:
      "Content teams and individual creators who generate, refine, and manage written content with AI and need to stay in control of the process.",
    productStructure: [
    ...
    result:
      "A polished conversational AI product interface that demonstrates fluency with the interaction patterns becoming table stakes in AI tools — streaming, artifacts, history, and control.",
    reflection:
  ...
  },
  {
    ...
    image: {
      src: "/work/vetbook.svg",
      alt: "VetBook veterinary practice management interface preview",
      width: 1280,
      height: 800,
    },
    highlight: "Designing operational software where every interaction matters.",
    problem:
    ...
    users:
      "Clinic receptionists, veterinarians, and practice managers who rely on the system for appointment handling and day-to-day operations.",
    productStructure: [
    ...
    result:
      "A domain-specific SaaS interface that proves the ability to design for complex operational workflows — scheduling, states, revenue, and activity — without sacrificing clarity.",
    reflection:
  ...
  },
  {
    ...
    image: {
      src: "/work/loanlens.svg",
      alt: "LoanLens multi-country loan calculator interface preview",
      width: 1280,
      height: 800,
    },
    highlight: "Making complex financial information easier to understand and act on.",
    problem:
    ...
    users:
      "Borrowers comparing loan scenarios across countries and repayment strategies, plus anyone trying to understand the true cost of a loan.",
    productStructure: [
    ...
    result:
      "A data-heavy interactive product that demonstrates the ability to design complex forms, financial calculations, and visualizations without the interface collapsing under its own complexity.",
    reflection:
  ...
  },
  {
    ...
    image: {
      src: "/work/saints-paradise.svg",
      alt: "Saint's Paradise Cafeteria brand website preview",
      width: 1280,
      height: 800,
    },
    highlight: "Designing digital experiences that make people want to act.",
    problem:
    ...
    users:
      "New and returning diners exploring the restaurant's identity, signature dishes, and menu, with strong visit intent.",
    productStructure: [
    ...
    result:
      "A high-impact marketing and brand experience that proves the ability to move from enterprise software to brand-led storytelling without losing craft.",
    reflection:
