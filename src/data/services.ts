...
export const principles: Principle[] = [
  ...
  },
  {
    ...
    description: "I design reusable patterns and components rather than isolated pages.",
  },
  {
    index: "03",
    title: "Complexity should feel simple.",
    description: "The product can be sophisticated. The experience shouldn't feel complicated.",
  },
  {
    index: "04",
    title: "Design with implementation in mind.",
    description: "A strong interface needs to survive the transition from Figma to production.",
  },
  {
    index: "05",
    title: "Details create trust.",
    description: "States, spacing, hierarchy, feedback, transitions, and responsiveness are part of the product—not finishing touches.",
  },
];
